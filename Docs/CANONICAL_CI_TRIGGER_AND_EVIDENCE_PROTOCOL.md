...
O workflow deve permanecer responsável por validação técnica. A decisão de compatibilidade canônica continua pertencendo ao processo governado do ELO.
...
Quando o HEAD não possuir workflow run verificável, o ELO deve diagnosticar nesta ordem, sem alterar o Core para contornar o bloqueio:
...
Esta frente melhora a coerência, rastreabilidade, identidade e manutenção do conhecimento existente. Não deve reinventar o ELO, criar uma segunda autoridade ou promover conteúdo somente para satisfazer o CI.
