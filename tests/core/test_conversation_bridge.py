...
def _event(**overrides):
    data = {
        "conversation_id": "conv-001", "tenant_id": "tenant-001", "domain": "elo",
        "principal": "user-001", "session_id": "session-001", "request_id": "request-001",
        "correlation_id": "corr-001", "source_id": "chat-001",
        "content": "Discussed a candidate architecture.", "authorized": True,
...
def test_bridge_ingests_authorized_event_into_temporal_context():
