from src.elo.agent_intake.hermes_context_plugin_boundary import (
    ContextEnginePluginSignal, PluginDisposition, assess_context_engine_plugin,
)

def _signal(**kw):
    base = dict(signal_id="ctx-001", tenant_scope="multiteiner", plugin_id="lcm",
