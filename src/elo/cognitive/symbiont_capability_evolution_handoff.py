...
into the existing SymbiontLabObservation contract. It does not create a lab,
Evolution Gate, learning store, or promotion authority.
"""
...
def prepare_capability_experiment_handoff(
    ...
    *,
    ...
    """Translate an explicit review action into the canonical lab contract."""
