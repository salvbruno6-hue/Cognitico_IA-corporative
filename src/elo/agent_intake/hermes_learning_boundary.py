...
The adapter models what ELO may receive from a skill-learning mechanism. It
never writes a skill, promotes knowledge, edits Core, or treats a learning
graph as authority.
"""
...
GRAPH_CAPABILITY_ID = "EXT-LEARNING-GRAPH-HERMES"
